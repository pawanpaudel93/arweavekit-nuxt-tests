...
<template>
  <div class="container mx-auto flex justify-center h-screen pt-12">
    <div class="flex flex-col gap-4 w-1/2">
      <button class="border-4" @click="logIn">LogIn with Othent</button>
      <button class="border-4" @click="logOut">LogOut with Othent</button>
      <input class="border-4" type="file" @change="handleFileChange" />
      <button class="border-4" @click="createArweaveTransaction">
        Create and Post Arweave Transaction
      </button>
      <button class="border-4" @click="createBundlrTransaction">
